...
async function request(url = '', method = 'GET', params = {}, withLoading) {
...
const getWithLoading = (url, params) => request(url, 'GET', params, true)
const postWithLoading = (url, params) => request(url, 'POST', params, true)
...
async function getDocDescription(id) {
    ...
    let list = await getWithLoading(`/data/summary/list${num}.json`)
...
function getDetail(doc) {
    ...
    return getWithLoading(filePath)
}
